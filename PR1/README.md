...
1.  Выполнение модуля Basic Building Blocks
...
result of 12 this time. When you use the assignment operator, R assumes
| that you don’t want to see the result immediately, but rather that you
...
about a particular function, you can access R’s built-in help files via
the `?` | command. For example, if you want more information on the c()
...
|=========================================== | 45% | Numeric vectors can
be used in arithmetic expressions. Type the following to see what
happens: z \* 2 + 100.
